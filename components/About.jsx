    ...
    <section>
        <div className="h-full">
            <div className="flex flex-col xl:flex-row justify-center items-center xl:justify-between">
                <div className="xl:basis-1/3 m-2 text-center overflow-hidden rounded-full">
                    <Image src="/assets/selfie_dom.png" alt="Selfie image" width="400" height="400" />
                </div>
                <div className="xl:basis-2/3 ml-20">
                    ...
                    <p className="text-white/80 mb-4">
                        ...
                        that will bring engagement and promote the user experience.&nbsp;
